...
public class CommentController {
    ...
    @PostMapping()
    public ResponseEntity<CommentSaveResponseDto> saveComment(@AuthenticationPrincipal User user, @Valid @RequestBody CommentSaveRequestDto commentSaveRequestDto){
